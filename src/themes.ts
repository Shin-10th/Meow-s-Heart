...
export const themes: ColorTheme[] = [
  {
    ...
    swatch: '#ea7ea4',
    vars: {
      '--color-brand-50': '#fef8fa',
      '--color-brand-100': '#fdf0f5',
      '--color-brand-200': '#fadce8',
      '--color-brand-300': '#f6bfd3',
      '--color-brand-400': '#f19fb9',
      '--color-brand-500': '#ea7ea4',
      '--color-brand-600': '#de4f81',
      '--color-brand-700': '#c72960',
      '--color-brand-800': '#9b224c',
      '--color-brand-900': '#781c3c',
      '--color-cream': '#fef8fa',
      '--color-cream-dark': '#fceef4',
      '--color-cocoa': '#5b3a29',
      '--color-cocoa-light': '#8a6a55',
      '--color-gold': '#ea7ea4',
      '--color-gold-light': '#fadce8',
    },
  },
  {
    id: 'pixelmeow',
